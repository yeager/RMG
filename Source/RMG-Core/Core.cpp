...
bool CoreInit(void)
{
    ...
    m64p_ret = m64p::Core.Startup(FRONTEND_API_VERSION, CoreGetUserConfigDirectory().string().c_str(), CoreGetSharedDataDirectory().string().c_str(), (void*)"[CORE]  ", CoreDebugCallback, nullptr, CoreStateCallback);
